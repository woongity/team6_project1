    ...
    <div class="row">
      ...
      <c:forEach var="item" begin="15" end="30" items="${productArray}" varStatus="status">
        ...
        <div class="text-center ps-0 pe-1" style="width: 16.5vw;">
          <a id="getModalBtn${status.index}"> <img src="<c:forEach var="i" items="${item.pimage1TreeSet}" begin="0" end="0">${i}</c:forEach>" class="card-img-top upper-image" id="homeImage1" alt="">
          </a>
